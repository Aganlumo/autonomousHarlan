...
def controlComm():
    ...
    while not rospy.core.is_shutdown():
        ...
        if last_time_stamp != time_stamp:
            ...
            kp_brk = 1.3    # jugar experimentalmente
            ...
            if camera_state == 2: #  camera lost
                ...
                if frame_id >= (next_frame_stop - 6) and frame_id <= (next_frame_stop + 6): # camera not lost and no emergency on PLC and at stop point
                    print 'Stop at post'
