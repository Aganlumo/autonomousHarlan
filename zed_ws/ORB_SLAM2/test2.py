...
if __name__ == '__main__':
    ...
    while not rospy.core.is_shutdown():
        ...
        error_t = math.atan(error_y/error_x)*(180/math.pi)#error de theta con respecto a la posicion
