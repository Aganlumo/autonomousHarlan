...
# codigo con subscriber de paro emergencia respecto a test7
import rospy
import math
import time
...
def nearKeyFrame(values):
    ...
    while condition != 1 or not rospy.core.is_shutdown():
        ...
        while frame_id < n - 1 and zed_pos_x_ != 1 and zed_pos_y_ != 1 or not rospy.core.is_shutdown():
...
if __name__ == '__main__':
    ...
    while not rospy.core.is_shutdown():
        ...
        rospy.Subscriber('motion_state', Int16, callback_motion)
