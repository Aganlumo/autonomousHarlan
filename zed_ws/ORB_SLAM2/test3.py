...
if __name__ == '__main__':
    ...
    while not rospy.core.is_shutdown():
        ...
        error_t = desired_t - zed_theta_  # hay que modificar para cuando el angulo se acerca 180####BORRAR
        calc_t = math.atan(error_x/error_y)*180/math.pi # error de theta con respecto a la posicion
...
########################################
        ...
        calc_gamma = z2n(kp*calc_t)
        gamma = z2n(kp*error_t) ####BORRAR
        print 'Con posicion: ', calc_gamma
        print 'Con angulo: ', gamma      ####BORRAR
        # print 'Speed: ', speed_d
